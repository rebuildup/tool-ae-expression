# tool-ae-expression Constitution

この文書は、tool-ae-expression の開発組織における最上位 contract です。
...
tool-ae-expression の開発組織の目的は current procedure への服従ではありません。
...
This repository owns source for one my-web-2025 embedded tool. The host repository and sibling UI repository remain separate authorities; relative-import layout is an explicit integration constraint, not repository ownership.
